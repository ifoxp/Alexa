...
class CalendarPlugin(SmartPlugin):
    ...
    async def startup_routine(self):
        ...
        if self.state["last_briefing_date"] != today_str:
            ...
            prompt = f"Ти помічник, називай користувача Сер. Склади дуже короткий ранковий брифінг. Події сьогодні: {today_events}. Дні народження найближчим часом: {upcoming_birthdays}. Скажи це красиво, українською мовою. Якщо подій немає, скажи, що день вільний."
